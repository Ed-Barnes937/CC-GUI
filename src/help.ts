...
const HELP_SECTIONS: [string, [string, string][]][] = [
  ...
  [
    ...
    [
      ...
      ["Type anything", "Fuzzy-search every file and folder in the repo (Esc clears)"],
      ["↑/↓", "Move the cursor"],
      ["Enter / →", "Open a folder, or reference the file as @path in the terminal"],
      ["Backspace", "Delete a search character, or go up to the parent folder"],
      ["Ctrl/Cmd+.", "Toggle hidden (dot) files"],
